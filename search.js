...
const instances = ['www.startpage.com/sp', 'searx.ox2.fr', 'search.mdosch.de/searxng', 'stract.com']; // a few engines that are reliable and I personally trust
...
form.action = 'https://' + instances[rand] + '/search'; // set the url redirect to selected instance
